<?php
/**
 * Soda Zoom Gallery Elementor Widget.
 *
 * @since 1.0.0
 */
class Soda_Zoom_Gallery_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'soda_zoom_gallery';
	}

	public function get_title() {
		return __( 'Zoom Gallery', 'soda-zoom-gallery' );
	}
