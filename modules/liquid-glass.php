...
/**
 * Liquid Glass Module
 * Adds liquid glass effect to Elementor sections, columns, containers, and widgets
 */
...
class Soda_Liquid_Glass {
    ...
    public function __construct() {
        // Register the module controls for sections, columns, and widgets
        ...
        add_action('elementor/element/container/section_layout/after_section_end', [$this, 'register_module_controls']);
     ...
     * @return string
     */
    public function render_widget_attributes($element, $id_suffix = '') {
        $settings = $element->get_settings_for_display();

        // Define setting keys using the suffix for reusability.
        ...
        // Initialize an array with any base classes passed to the function.
        $classes = [];

        // Conditionally add liquid glass classes if the feature is enabled in settings.
        ...
        // If there are no classes to apply, exit early.
        if (empty($classes)) {
            return '';
        }

        // Build the final class string, filtering out any empty array elements.
