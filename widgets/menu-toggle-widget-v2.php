...
class Elementor_Menu_Toggle_Widget_V2 extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .horizontal-menu-nav .sub-menu' => 'padding-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        <div class="menu-widget-container <?php echo esc_attr($position_class); ?> <?php echo esc_attr($menu_type_class); ?>"<?php echo $data_attrs; ?>>
            ...
            ?>
                <nav class="horizontal-menu-nav <?php echo implode(' ', $horizontal_classes); ?>" data-submenu-icon="<?php echo esc_attr($submenu_icon); ?>">
                    <?php
                    wp_nav_menu([
